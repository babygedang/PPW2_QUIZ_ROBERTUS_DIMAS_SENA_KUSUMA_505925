    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            <div class="overflow-hidden rounded-lg shadow-md m-5">
                    ...
                    <div class="container mx-auto">
                        ...
                        @auth
                            <form method="post" action="{{ route('buku.favorite', ['id' => $bukus->id]) }}">
                                @csrf
                                <button type="submit" class="inline-block px-4 py-2 border border-blue-500 text-blue-500 bg-blue-100 rounded mt-4">Save to Favorites</button>
                            </form>
                        @endauth
                ...
                <a href="{{ route('buku.index') }}" class="inline-block px-4 py-2 border border-red-500 text-red-500 bg-red-100 rounded mt-4">
